...
tcl (pt_<version>.vim), dc_shell tcl (dctl_<version>.vim).  A file for 
einstimer/booldozer tcl (einsstd.vim) is also available.
...
set complete=k~/.vim/syntax/ptstd.dict
